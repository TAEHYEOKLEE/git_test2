...
<script>
function agreeCheck(){
	var chk = document.getElementById("agreement1");
	if(chk.checked==true){
		alert("약관에 동의하여 회원가입 진행^^*");
		location.href="join02.jsp";
	}
	else{
		alert("약관에 동의해야 회원가입 가능함");
	}
}
</script>
<p style="text-align:center; margin-bottom:20px;">
<input type="checkbox" id="agreement1" value="">이용약관과 개인정보취급방침에 동의합니다.</p>

<p style="text-align:center; margin-bottom:20px">
	<!-- 확인버튼 -->
	<a href="javascript:agreeCheck();"><img src="../images/btn01.gif" /></a>
	&nbsp;&nbsp;
	<!-- 취소버튼 -->
...
<!-- ###################### -->
<!-- 
a태그에서 Javascript 함수 호출하는 방법
1.href속성 사용
	<a href="javascript:함수명();">링크임</a>

2.onclick속성 사용
	<a href="#" onclick="함수명();">링크임</a>
	또는
	<a href="#" onclick="javascript:함수명();">링크임</a>
	위의 경우 함수실행후 페이지 상단으로 자동으로 이동
	하는 단점이 있다.
	따라서 아래와 같이 하는것이 가장 바람직하다.
	<a href="javascript:;" onclick="함수명();">링크</a>
-->
<!-- ###################### -->
			</div>
		</div>
