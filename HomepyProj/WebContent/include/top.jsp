...
<div id="top" style="border:0px solid #000;"> 
	...
	%>
		<!-- 로그인전 -->
		<li><a href="../member/login.jsp">
			<img src="../images/lnb01.gif" alt="LOGIN" /></a></li>
		<li><a href="../member/join01.jsp">
			<img src="../images/lnb02.gif" alt="JOIN" /></a></li>
	<% } else { %>
		<!-- 로그인후 -->
		<li><a href="../member/logout.jsp">
			<img src="../images/lnb05.gif" alt="LOG OUT" /></a></li>
		<li><a href="../member/modify.jsp">
			<img src="../images/lnb06.gif" alt="MODIFY" /></a></li>
	<% } %>
	...
	<map name="GNB">
		...
		<area shape="rect" alt="" title="" coords="428,0,529,33" href="../space/sub01_t_list.jsp" target="" /><!-- ../space/sub01_list.jsp -->
		<area shape="rect" alt="" title="" coords="536,0,638,33" href="../Community/CommList" target="" /><!-- ../community/sub01.jsp -->
