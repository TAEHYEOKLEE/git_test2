			...
			<div class="right_contents">
				...
				<div class="con_box">
					...
					<div id="map" style="width:100%;height:350px;"></div>
						...
						<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=e5e93007c2bb95d1f428bf71286179c7"></script>
						<script>
						var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
						    mapOption = { 
						        center: new daum.maps.LatLng(37.478866, 126.878916), // 지도의 중심좌표
						        level: 3 // 지도의 확대 레벨
						    };
						...
						// 마커가 표시될 위치입니다 
						var markerPosition  = new daum.maps.LatLng(37.478866, 126.878916); 
